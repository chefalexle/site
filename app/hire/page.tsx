    ...
    return (
        <>
            ...
            <section className={`${styles['intro']} section`}>
                ...
                <a className={`${styles['dl-link']}`} target="_blank" href="https://drive.google.com/uc?export=download&id=1ks_aPXQTMIaIAyg7sxlXb_R-GJ4hoyjW" rel="noopener noreferrer">
                    <div className={`${styles['dl']}`}>
                        <h3>Download</h3>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#c91c64" className="bi bi-file-earmark-pdf" viewBox="0 0 16 16">
